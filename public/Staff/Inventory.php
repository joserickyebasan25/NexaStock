...
<div class="flex">
    <aside class="w-64 hidden lg:block h-[calc(100vh-64px)] p-4 border-r border-white/5">
        <ul class="menu w-full p-0 gap-1 text-slate-400">
            ...
            <li><a href="Inventory.php" class="active bg-blue-600/10 text-blue-400"><i class="fas fa-boxes-stacked"></i> Inventory</a></li>
    ...
    <main class="flex-1 p-6 space-y-8 max-w-7xl mx-auto">
        <section>
            <h2 class="text-lg font-bold">Inventory Management</h2>
            <p class="text-sm text-slate-400">Monitor and manage current stock levels.</p>
        </section>
